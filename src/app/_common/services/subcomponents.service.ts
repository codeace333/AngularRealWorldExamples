  ...
  constructor() {
    ...
    this.arrmixComponentLists = [
      ...
      },
      {
        ...
        children: [
          { name: 'Observable', description: 'Learn More Observable In Details', path: '/observable' },
          { name: 'Http Observable', description: 'Learn More Observable In Details', path: '/nestedrouting' },
      ...
      {
        name: 'Promises', description: 'Learn More Promises In Details', path: '/observable',
        children: [
